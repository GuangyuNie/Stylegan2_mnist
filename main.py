...
class Config:
    def __init__(self):
        ...
        self.style_mixing_prob = 0 # Disable style mixing
        self.gradient_accumulate_steps = 1
        self.checkpoint_save_interval = 2500
    ...
    def step(self, idx):
        ...
        torch.nn.utils.clip_grad_norm(self.mapping_network.parameters(), max_norm=1.0)
